...
public class DrivebaseS extends SubsystemBase implements Loggable {
    ...
    public void periodic() {
        ...
        var result = m_cameraWrapper.getEstimatedGlobalPose(getPose());
        if (result.isPresent()) {
    ...
    public void simulationPeriodic() {
        ...
        m_simPigeon2.addHeading(m_quadSwerveSim.getCurPose().minus(prevRobotPose).getRotation().getDegrees());
